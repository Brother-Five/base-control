...
void bsp_KeyScan(void)
{
	...
	#ifdef USE_KEY1
		case GPIO_PIN_K1:bsp_DetectKey(0);break;/* K1 按键 */
	#endif

	#ifdef USE_KEY2
		case GPIO_PIN_K2:bsp_DetectKey(1);break;/* K2 按键 */
	#endif
	...
	#ifdef USE_KEY4
		case GPIO_PIN_K4:bsp_DetectKey(3);break;/* K4 按键 */
	#endif

	#ifdef USE_KEY5
		case GPIO_PIN_K5:bsp_DetectKey(4);break;/* K5 按键 */
	#endif

	#ifdef USE_KEY6
		case GPIO_PIN_K6:bsp_DetectKey(5);break;/* K6 按键 */
	#endif

	#ifdef USE_KEY7
		case GPIO_PIN_K7:bsp_DetectKey(6);break;/* K7 按键 */
	#endif

	#ifdef USE_KEY8
		case GPIO_PIN_K8:bsp_DetectKey(7);break;/* K8 按键 */
	#endif
		default:break;
	}
#else
